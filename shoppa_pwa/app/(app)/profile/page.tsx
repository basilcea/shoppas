    ...
    <AuthenticatedLayout>
      ...
      <section className="space-y-4 mb-6">
       ...
       <section className="mb-6">
         <div className="bg-gradient-to-br from-primary/10 to-primary-container/10 rounded-2xl p-6 border border-primary/20">
           <div className="flex items-center gap-4 mb-4">
             <div className="w-12 h-12 bg-primary-fixed/30 rounded-xl flex items-center justify-center">
               <span className="material-symbols-outlined text-primary">download</span>
             </div>
             <div>
               <h3 className="font-bold text-on-surface">Get the Mobile App</h3>
               <p className="text-xs text-on-surface-variant">Install Shoppa on your device</p>
             </div>
           </div>
           <Button variant="primary" fullWidth size="md" href="/app/download">
             Download Now
           </Button>
         </div>
       </section>
