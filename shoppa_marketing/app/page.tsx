      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <div className="bg-primary-container rounded-[3rem] p-12 md:p-24 text-center space-y-8 relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-4 relative z-10">
            <button className="bg-white text-primary px-10 py-5 rounded-2xl font-extrabold text-xl shadow-ambient flex items-center justify-center gap-3 hover:scale-[1.02] transition-transform"><span className="material-symbols-outlined">download</span>Download App</button>
            <Link href="/features" >
